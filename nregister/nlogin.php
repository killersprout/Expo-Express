...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, username, firstname, lastname, password, event FROM community WHERE username = ?"; //Query, looking for the username that was inputted
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    //New result statemnt
                    mysqli_stmt_bind_result($stmt, $id, $username,$firstname, $lastname,$hashed_password,$event);
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <p>Don't have an account? <a href="nregister.php">Sign up now</a>.</p>
