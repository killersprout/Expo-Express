...
if (isset($_POST['submit']))
{
    ...
    {
        $query = "SELECT voting FROM voting_questions WHERE organization = ?";
        ...
        if($stmt = mysqli_prepare($link, $query))
        {
            ...
            if(mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    //update questions
                    $query = "UPDATE voting_questions SET voting = ? WHERE organization = ?";
                    ...
                    if ($stmt = mysqli_prepare($link, $query)) {
                        ...
                        mysqli_stmt_bind_param($stmt, "si", $paramQuestion, $paramOrg);
                        $paramOrg = $orgName;
                        $paramQuestion = implode(', ', $valueArr);
                ...
                {
                    $query = "INSERT INTO voting_questions(organization, voting, judging) VALUES (?, ?, ?);";
...
<div class="wrapper">
    <h2 align="center">Add Questions for Voting</h2>
