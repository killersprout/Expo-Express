...
$query = "SELECT judging FROM voting_questions WHERE organization ='".$orgName."' AND event = '".$eventName."'";
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($_POST['add'])){
                    ...
                    $query = "UPDATE voting_questions SET judging = ? WHERE organization = ? AND event = ?";
                ...
                <div class="wrapper">
                    <?php
                    echo '<h3 align="left" style="margin-left:20px;">Current Judging Categories for Event: '.$eventName.'</h3>';
                    ?>
                    <br>
                    ...
                    <h3 align="left" style="margin-left:20px;">Add Judging Categories </h3>
                    <form align='center' name="add_division" id="add_division" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dynamic_field">
                                <tr>
                                    <td><input type="text" name="division[]" placeholder="Enter Judging Category" class="form-control division_list" required="" /></td>
